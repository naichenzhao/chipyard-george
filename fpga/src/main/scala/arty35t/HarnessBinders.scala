...
class WithArty35TUARTTSI extends HarnessBinder({
  case (th: HasHarnessInstantiators, port: UARTTSIPort, chipId: Int) => {
    val ath = th.asInstanceOf[LazyRawModuleImp].wrapper.asInstanceOf[Arty35THarness]
...
class WithArty35TDDRTL extends HarnessBinder({
  case (th: HasHarnessInstantiators, port: TLMemPort, chipId: Int) => {
    val artyTh = th.asInstanceOf[LazyRawModuleImp].wrapper.asInstanceOf[Arty35THarness]
...
// Uses PMOD JA/JB
class WithArty35TSerialTLToGPIO extends HarnessBinder({
...
class WithArty35TUART(rxdPin: String = "A9", txdPin: String = "D10") extends HarnessBinder({
...
class WithArty35TPMODUART extends WithArty35TUART("G2", "F3")

class WithArty35TJTAG extends HarnessBinder({
